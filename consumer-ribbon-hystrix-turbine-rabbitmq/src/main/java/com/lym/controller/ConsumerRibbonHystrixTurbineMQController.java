...
public class ConsumerRibbonHystrixTurbineMQController {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConsumerRibbonHystrixTurbineMQController.class);
